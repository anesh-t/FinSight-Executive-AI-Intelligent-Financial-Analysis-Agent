-- ============================================================================
-- CREATE COMBINED VIEWS - VERIFIED WITH ACTUAL DATABASE SCHEMA
-- Run this in Supabase SQL Editor
-- ============================================================================
-- All column names verified against actual database:
-- ✅ mv_ratios_annual: gross_margin_annual, operating_margin_annual, net_margin_annual, 
--    roa_annual, roe_annual_avg_equity, debt_to_assets_annual, debt_to_equity_annual,
--    rnd_to_revenue_annual, sgna_to_revenue_annual
-- ✅ mv_stock_prices_annual: avg_price_annual, return_annual, volatility_pct_annual, etc.
-- ✅ fact_financials: revenue, net_income, eps, r_and_d_expenses, sg_and_a_expenses, buybacks
-- ✅ vw_ratios_quarter: gross_margin, operating_margin, net_margin, roe, roa, 
...
SELECT 
    ...
    -- Stock (from vw_stock_prices_quarter)
...
SELECT 
    ...
    -- Financials (from mv_financials_annual - ACTUAL COLUMNS ONLY!)
    fa.revenue_annual, fa.net_income_annual, fa.operating_income_annual, fa.gross_profit_annual,
    fa.ebit_annual, fa.ebitda_annual,
    fa.r_and_d_expenses_annual, fa.sg_and_a_expenses_annual, fa.cogs_annual,
    ...
    fa.capex_annual,
    fa.quarters_count, fa.has_full_year,
    
    -- Ratios (from mv_ratios_annual - VERIFIED COLUMN NAMES!)
    ra.gross_margin_annual,
    ra.operating_margin_annual,
    ra.net_margin_annual,
    ra.roa_annual,
    ra.roe_annual_avg_equity as roe_annual,  -- ACTUAL COLUMN NAME!
    ra.debt_to_assets_annual,
    ra.debt_to_equity_annual,
    ra.rnd_to_revenue_annual as rd_intensity_annual,
    ra.sgna_to_revenue_annual as sga_intensity_annual,
    
    -- Stock (from mv_stock_prices_annual - VERIFIED COLUMN NAMES!)
...
-- ============================================================================
-- SUCCESS! ALL 6 COMBINED VIEWS CREATED WITH VERIFIED COLUMN NAMES
-- ============================================================================
