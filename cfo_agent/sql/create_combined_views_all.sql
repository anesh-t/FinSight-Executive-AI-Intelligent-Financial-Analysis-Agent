-- ============================================================================
-- CREATE ALL COMBINED VIEWS - COMPLETE SCRIPT
-- Run this ENTIRE file in your database admin tool
-- ============================================================================
...
\echo '============================================================================'
\echo 'CREATING COMBINED VIEWS - LAYERED APPROACH'
\echo '============================================================================'
...
\echo ''
\echo '[1/6] Creating vw_company_complete_quarter (Layer 1 - Quarterly)...'
...
\echo '✓ Created vw_company_complete_quarter'

-- ----------------------------------------------------------------------------

\echo ''
\echo '[2/6] Creating vw_company_macro_context_quarter (Layer 2 - Quarterly)...'
...
\echo '✓ Created vw_company_macro_context_quarter'

-- ----------------------------------------------------------------------------

\echo ''
\echo '[3/6] Creating vw_company_full_quarter (Layer 3 - Quarterly)...'
...
\echo '✓ Created vw_company_full_quarter'
...
\echo ''
\echo '[4/6] Creating mv_company_complete_annual (Layer 1 - Annual)...'
...
\echo '✓ Created mv_company_complete_annual'

-- ----------------------------------------------------------------------------

\echo ''
\echo '[5/6] Creating mv_company_macro_context_annual (Layer 2 - Annual)...'
...
\echo '✓ Created mv_company_macro_context_annual'

-- ----------------------------------------------------------------------------

\echo ''
\echo '[6/6] Creating mv_company_full_annual (Layer 3 - Annual)...'
...
\echo '✓ Created mv_company_full_annual'
...
\echo ''
\echo '✅ ALL 6 COMBINED VIEWS CREATED SUCCESSFULLY!'
\echo ''
\echo 'Next steps:'
\echo '1. Update agent templates (catalog/templates.json)'
\echo '2. Update decomposer (decomposer.py)'
\echo '3. Update formatter (formatter.py)'
\echo '4. Update whitelist (db/whitelist.py)'
\echo '5. Run tests'
