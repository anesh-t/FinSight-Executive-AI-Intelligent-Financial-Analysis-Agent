-- ============================================================================
-- CREATE ALL COMBINED VIEWS - FIXED FOR ACTUAL SCHEMA
-- Run this ENTIRE file in Supabase SQL Editor
-- ============================================================================
-- Creates 6 combined views (3 quarterly + 3 annual) in layered approach
-- Uses actual column names from fact_financials table
-- ============================================================================
...
SELECT 
    ...
    -- Financials (using actual column names)
    f.revenue, 
    f.gross_profit, 
    f.operating_income, 
    f.net_income, 
    f.ebitda, 
    f.eps,  -- NOT eps_diluted
    f.r_and_d_expenses,  -- NOT rd_expenses
    f.sg_and_a_expenses,  -- NOT sga_expenses
    f.cogs,
    f.total_assets, 
    f.total_liabilities, 
    f.equity,  -- NOT total_equity
    f.cash_flow_ops,  -- NOT operating_cf
    f.cash_flow_investing,  -- NOT investing_cf
    f.cash_flow_financing,  -- NOT financing_cf
    f.capex, 
    f.dividends,  -- NOT dividends_paid
    f.buybacks,
    -- Ratios
    r.gross_margin, 
    r.operating_margin, 
